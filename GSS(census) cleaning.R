...
raw_data <- read_csv("/Users/apple/Desktop/FINAL PROJECT/AAstxEAM.csv")
dict <- read_lines("/Users/apple/Desktop/FINAL PROJECT/gss_dict.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("/Users/apple/Desktop/FINAL PROJECT/gss_labels.txt")
...
# working directory
write_csv(reduced_data, "GSS(census).csv")
